...
class MainNet(nn.Module):
    def __init__(self, 
                 device, 
                 imgSize=280,
                 depth_weight_path=r"Y:\2025-2026\NEW DEV\JAN 2026\TK206833 -Adaptive Qualityaware underwater image enhancement using multiscale fusion\CODE\front end\Front end\checkpoints\depth_anything_v2_vits.pth"):
